  ...
  create  table "citibike_db"."public"."int_biketrip_hourly_net_flow__dbt_tmp"
...
WITH pickups AS (
    ...
    FROM "citibike_db"."public"."int_biketrip_hourly_pickups"
...
drops AS (
    ...
    FROM "citibike_db"."public"."int_biketrip_hourly_drops"
    GROUP BY station_id, date_hour
)
